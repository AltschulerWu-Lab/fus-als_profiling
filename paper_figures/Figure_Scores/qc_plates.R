#' # Figure plate QC
#' The following script evaluates plate-level generalizability. FUS-ALS vs. 
#' WT classifiers are trained with data from an entire plate held-out during
#' training. Predictions are evaluated on hold-out plate data to determine
#' whether signal for FUS-ALS vs. WT classification exceeds plate-plate 
#' variability. 
#' 
#' Requires input datasets
#'   `data/032422_WTFUSSporadics/Cell_Filtered/profiles_FUS_EEA1.Rdata`
#' 
